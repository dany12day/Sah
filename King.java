public class King extends Piece{
	...
	public King(int team, Position curentPosition, String name) {
		super();
		super.team=team;
	...
	public int isValidMove(Position futurePosition, Table table) {
		if(table.getPiece(futurePosition).getTeam()==table.getPiece(curentPosition).getTeam())
			return 0;
		if(Math.abs(futurePosition.getX()-curentPosition.getX())==1 || Math.abs(futurePosition.getY()-curentPosition.getY())==1)
			return 1;
		return 0;
	}
